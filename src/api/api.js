import { getAuthToken, getStoredToken, refreshToken, removeToken } from "./auth";
    ...
    try {
        ...
        if (response.status === 401) {
            ...
            if (newToken) {
                ...
                console.error('Не удалось обновить токен. Пользователю требуется повторный вход.');
                removeToken();
...
export async function bookRoom(roomId, fromReserve, toReserve) {
